...
export const metadata: Metadata = {
  title: "DIY vs. Professional Web Design: When to Hire an Expert | WebFuZsion",
  description:
  ...
  keywords: [
    ...
    "when to hire web designer",
    "web design cost comparison",
  ...
  authors: [{ name: "WebFuZsion Team" }],
  openGraph: {
    title: "DIY vs. Professional Web Design: When to Hire an Expert",
    description:
      "Discover when to build your own website vs. hiring a professional web designer. Compare costs, time, quality, and long-term benefits.",
    type: "article",
    url: "https://webfuzsion.co.uk/blog/diy-vs-professional-web-design",
    images: [
      {
        url: "https://webfuzsion.co.uk/diy-vs-professional-web-design.png",
        width: 1200,
        height: 630,
        alt: "DIY vs Professional Web Design Comparison",
      },
    ],
    siteName: "WebFuZsion",
  },
  twitter: {
    ...
    description:
      "Discover when to build your own website vs. hiring a professional web designer. Compare costs, time, quality, and long-term benefits.",
    images: ["https://webfuzsion.co.uk/diy-vs-professional-web-design.png"],
    creator: "@webfuzsion",
  },
  alternates: {
    canonical: "https://webfuzsion.co.uk/blog/diy-vs-professional-web-design",
  },
  robots: {
    index: true,
    follow: true,
...
const blogPost = {
  ...
  imageUrl: "/diy-vs-professional-web-design.png",
  excerpt:
    "Discover when to build your own website vs. hiring a professional web designer. Compare costs, time, quality, and long-term benefits to make the right choice for your business.",
...
export default function DIYVsProfessionalWebDesignPage() {
  return <BlogPostClient blogPost={blogPost} slug="diy-vs-professional-web-design" />
}
