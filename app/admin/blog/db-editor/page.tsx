...
import { saveBlogPostToDb } from "../../../actions/blog-db-actions"

export default function DbBlogEditor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Form data created, calling saveBlogPostToDb")
      const result = await saveBlogPostToDb(formData)
      console.log("Result from saveBlogPostToDb:", result)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Create New Blog Post (Database)</h1>
        <button
          type="button"
