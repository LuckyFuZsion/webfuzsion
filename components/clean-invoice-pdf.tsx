...
// Define the props for the CleanInvoicePDF component
interface CleanInvoicePDFProps {
  invoice: {
...
export const CleanInvoicePDF: React.FC<CleanInvoicePDFProps> = ({ invoice, customer, items }) => {
  // Format date strings
